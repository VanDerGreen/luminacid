...
export default function BlogClient({ posts }: { posts: Post[] }) {
  ...
  return (
    <main className="relative min-h-screen bg-[#020202] text-white px-6 py-24 overflow-x-hidden antialiased">
      ...
      {/* BACKGROUND ATMOSPHERE - Always visible */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="relative space-y-4">
          {/* Static timeline line to provide immediate context */}
          ...
          <AnimatePresence mode="wait">
            {/* We only map if mounted to ensure Framer Motion animations trigger correctly without hydration mismatches */}
            {mounted ? (
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                      <div className="max-w-2xl">
                        <div className="flex items-center gap-3 mb-3">
                          <p className="text-[10px] font-black tracking-[0.3em] uppercase text-purple-400/80 group-hover:text-purple-300 transition-colors">
                            {post.date}
                          </p>
              ...
              /* Skeleton/Placeholder state to maintain height and context during hydration */
              <div className="pl-10 md:pl-16 py-10 opacity-10">
